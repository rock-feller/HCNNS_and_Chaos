...
graph = make_dot(loss, params = {"A": cell.A.weight,
                            ...
                            "loss term": loss, "state_s0": state , "delta_term": delta_term,
                            "dropout_deltaterm": dropout_deltaterm, "s": state, "r": r})

graph.render("computational_graph_HCNNPTF_Arch", format="png")
